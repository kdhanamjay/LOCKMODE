...
class DatabaseStore {
  ...
  public seedDatabase() {
    ...
    this.applications = [
      ...
      {
        id: 'app-pc-python',
        packageName: 'org.python.idle',
        name: 'Python IDLE (Python 3.12)',
        version: '3.12.3',
        versionCode: 3120,
        ...
        isDesktopApp: true,
        exePath: 'pythonw.exe -m idlelib.idle',
        protocolUri: 'python:',
        launchCommand: 'start pythonw -m idlelib.idle',
        description: 'Installed Python Interactive Development and Learning Environment with real-time code execution, file save, and interactive practice.',
        distributionType: 'WINDOWS_EXE',
        installedCount: 248,
        pendingCount: 0,
        failedCount: 0,
        createdAt: '2025-08-20T08:00:00.000Z',
      ...
      },
      {
        ...
        exePath: 'WINWORD.EXE',
        protocolUri: 'ms-word:',
        launchCommand: 'start winword',
        description: 'Installed Microsoft Word processor for curriculum assignments, thesis formatting, and student documentation with local file save.',
        distributionType: 'WINDOWS_EXE',
        installedCount: 248,
        pendingCount: 0,
        failedCount: 0,
      ...
      },
      {
        ...
        launchCommand: 'start excel',
        description: 'Installed Microsoft Excel spreadsheet software for math tables, statistical analysis, formulas, charts, and data science practice.',
        distributionType: 'WINDOWS_EXE',
        installedCount: 248,
        pendingCount: 0,
        failedCount: 0,
      ...
      {
        id: 'app-pc-powerpoint',
        packageName: 'com.microsoft.office.powerpoint',
        name: 'Microsoft PowerPoint',
        version: '2024 / 365',
        versionCode: 1600,
        publisher: 'Microsoft Corporation',
        iconUrl: 'https://images.unsplash.com/photo-1542744094-3a31f272c490?w=128&auto=format&fit=crop&q=80',
        category: 'PRODUCTIVITY',
        isApproved: true,
        isApprovedForStudent: true,
        isDesktopApp: true,
        ...
        launchCommand: 'start powerpnt',
        description: 'Installed Microsoft PowerPoint for student seminar slide decks, visual project presentations, and design practice.',
        distributionType: 'WINDOWS_EXE',
        installedCount: 248,
        pendingCount: 0,
        failedCount: 0,
      ...
      },
      {
        ...
        description: 'Installed Visual Studio Code code editor with syntax highlighting, terminal support, and multi-language development tools.',
        distributionType: 'WINDOWS_EXE',
        installedCount: 215,
        pendingCount: 0,
        failedCount: 0,
      ...
      {
        id: 'app-pc-notepad',
        packageName: 'com.microsoft.windows.notepad',
        name: 'Windows Notepad',
        version: '11.2401',
        versionCode: 110,
        publisher: 'Microsoft Windows System',
        iconUrl: 'https://images.unsplash.com/photo-1586075010923-2dd4570fb338?w=128&auto=format&fit=crop&q=80',
        category: 'UTILITY',
        isApproved: true,
        isApprovedForStudent: true,
        isDesktopApp: true,
        exePath: 'notepad.exe',
        launchCommand: 'start notepad',
        description: 'Native Windows plain-text editor and rapid note-taking scratchpad pre-installed on host workstation.',
        distributionType: 'WINDOWS_EXE',
        installedCount: 248,
        pendingCount: 0,
        failedCount: 0,
